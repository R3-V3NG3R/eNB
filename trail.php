		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><font size="6px">Welcome To <b>Srikakulam Notice Board </b></font></a>
                </div>
				...
				<div style="width:100%; text-align:center;">
					<nav class="pages">
					  <ul class="pagination pagination-lg">
					    <li class="page-item"><a class="page-link" href="main.php?next=$pageNum">&laquo;</a></li>
HERE;
						for ($i=1; $i <=$total ; $i++) {
							if($i==$pageNum){
								$class="active";
